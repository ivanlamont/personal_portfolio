...
const EducationSectionBox: React.FC = () => {
    ...
    return <Box> 
        ...
        <VStack marginTop={120}>
            ...
            <Box>              
                I have applied to the University of Texas at Austin, for admission to their <Link href="https://cdso.utexas.edu/msai" target="_blank">Masters in Artificial Intelligence</Link> course.  It looks to be one of the best courses in the world, and I am very excited about the prospect of studying there.
            </Box>
            <Box> 
